...
class ObjectPropertiesTest extends AccountTestCase
{
    /**
    ...
    {
        $this->playerSetResearchLevel('armor_technology', 1);
        ...
        $this->assertEquals(4400, $lightFighter->properties->structural_integrity->calculate($this->planetService->getPlayer())->totalValue);
    }
    ...
    public function testShieldPropertyCalculation(): void
    {
        ...
        $this->assertEquals(13, $lightFighter->properties->shield->calculate($this->planetService->getPlayer())->totalValue);
    }
    ...
    public function testAttackPropertyCalculation(): void
    {
        ...
        $this->assertEquals(60, $lightFighter->properties->attack->calculate($this->planetService->getPlayer())->totalValue);
    }
    ...
    {
        $this->playerSetResearchLevel('combustion_drive', 5);
        $this->playerSetResearchLevel('impulse_drive', 3);
        $this->playerSetResearchLevel('hyperspace_drive', 4);

        // Light fighter
        // Base 12.500 + 5*10% = 18.750
        $lightFighter = ObjectService::getShipObjectByMachineName('light_fighter');
        $this->assertEquals(12500, $lightFighter->properties->speed->rawValue);
        $this->assertEquals(18750, $lightFighter->properties->speed->calculate($this->planetService->getPlayer())->totalValue);
        ...
        $this->assertEquals(7500, $smallCargo->properties->speed->calculate($this->planetService->getPlayer())->totalValue);
        ...
        $this->assertEquals(3000, $recycler->properties->speed->calculate($this->planetService->getPlayer())->totalValue);
        ...
        $this->assertEquals(24000, $cruiser->properties->speed->calculate($this->planetService->getPlayer())->totalValue);
        ...
        $this->assertEquals(22000, $battleship->properties->speed->calculate($this->planetService->getPlayer())->totalValue);
    }
    ...
    {
        $this->playerSetResearchLevel('impulse_drive', 5);
        $this->playerSetResearchLevel('hyperspace_drive', 15);

        // Small cargo with impulse drive level 5 (upgrade)
        // Base speed overridden to 10,000 at Impulse 5, then bonus: 10,000 + 5*20% = 20,000
        $smallCargo = ObjectService::getShipObjectByMachineName('small_cargo');
        $this->assertEquals(20000, $smallCargo->properties->speed->calculate($this->planetService->getPlayer())->totalValue);

        // Recycler with hyperspace drive level 15
        // Base speed overridden to 6,000 at Hyperspace 15, then bonus: 6,000 + 15*30% = 33,000
        $recycler = ObjectService::getShipObjectByMachineName('recycler');
        $this->assertEquals(33000, $recycler->properties->speed->calculate($this->planetService->getPlayer())->totalValue);
        ...
        $this->assertEquals(27500, $recycler->properties->speed->calculate($this->planetService->getPlayer())->totalValue);
    }
    ...
    public function testCapacityPropertyCalculation(): void
    {
        ...
        $lightFighter = ObjectService::getShipObjectByMachineName('light_fighter');
        $this->assertEquals(50, $lightFighter->properties->capacity->calculate($this->planetService->getPlayer())->totalValue);
    }
    ...
    public function testFuelPropertyCalculation(): void
    {
        ...
        $lightFighter = ObjectService::getShipObjectByMachineName('light_fighter');
        $this->assertEquals(20, $lightFighter->properties->fuel->calculate($this->planetService->getPlayer())->totalValue);
    }
    ...
    {
        // No special setup needed - using default planet/player state
    ...
    public function testPropertyBonusRetrieval(): void
    {
        ...
        // Light fighter check
        $lightFighter = ObjectService::getShipObjectByMachineName('light_fighter');
        $calculated = $lightFighter->properties->structural_integrity->calculate($this->planetService->getPlayer());
