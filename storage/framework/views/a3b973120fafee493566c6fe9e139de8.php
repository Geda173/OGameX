<?php $__env->startSection('content'); ?>
    ...
    <div id="galaxycomponent" class="maincontent">
        <script type="text/javascript">
            var galaxy = <?php echo e($current_galaxy); ?>;
            var system = <?php echo e($current_system); ?>;
            var maxGalaxies = <?php echo e($max_galaxies); ?>;
            var maxSystems = 499;
            var spionageAmount = 3;
            var contentLink = "<?php echo e(route('galaxy.ajax')); ?>";
            var galaxyContentLink = "<?php echo e(route('galaxy.ajax')); ?>";
            ...
            {
                let expeditionLink = "<?php echo e(route('fleet.index')); ?>";
        ...
        <div id="inhalt">
            ...
            <div id="galaxyHeader" class="ct_head_row">
                <form action="<?php echo e(route('galaxy.ajax')); ?>" name="galaform" method="post">
...
<?php echo $__env->make('ingame.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ingame/galaxy/index.blade.php ENDPATH**/ ?>