<div class="detail_msg_head">
    ...
    <span class="msg_title new blue_txt"><?php echo $subject; ?></span>
    <span class="msg_date fright">21.05.2024 19:00:28</span>
    <br/>
    <span class="msg_sender_label"><?php echo app('translator')->get('From'); ?>: </span>
    <span class="msg_sender"><?php echo e($from); ?></span>
...
<div class="detail_msg_ctn">
    ...
    <div class="detail_txt">
        <span><?php echo app('translator')->get('Player'); ?>&nbsp;&nbsp;<span class="status_abbr_active"><?php echo $playername; ?></span></span>
    </div>
    <div class="detail_txt">
        <span><?php echo app('translator')->get('Class'); ?>:<span class="status_abbr_inactive">&nbsp;<?php echo app('translator')->get('Unknown'); ?></span></span>
    </div>
    <div class="detail_txt">
        <span><?php echo app('translator')->get('Alliance Class'); ?>:&nbsp;<span class="alliance_class small none"><?php echo app('translator')->get('No alliance class selected'); ?></span></span>
    </div>
    <div class="detail_txt">
        <?php echo app('translator')->get('Chance of counter-espionage'); ?>: 0%
        <div class="">
            <?php echo app('translator')->get('Your espionage does not show abnormalities in the atmosphere of the planet. There appears to have been no activity on the planet within the last hour.'); ?>
        </div>
    </div>
    <div class="section_title">
        <div class="c-left"></div>
        <div class="c-right"></div>
        <span class="title_txt"><?php echo app('translator')->get('Resources'); ?></span>
    </div>
    <ul class="detail_list clearfix" data-type="resources">
        <li class="resource_list_el tooltipCustom" title="<?php echo e($resources->metal->getFormattedFull()); ?>">
            <div class="resourceIcon metal"></div>
            <span class="res_value"><?php echo e($resources->metal->getFormattedLong()); ?></span>
        </li>
        <li class="resource_list_el tooltipCustom" title="<?php echo e($resources->crystal->getFormattedFull()); ?>">
            <div class="resourceIcon crystal"></div>
            <span class="res_value"><?php echo e($resources->crystal->getFormattedLong()); ?></span>
        </li>
        <li class="resource_list_el tooltipCustom" title="<?php echo e($resources->deuterium->getFormattedFull()); ?>">
            <div class="resourceIcon deuterium"></div>
            <span class="res_value"><?php echo e($resources->deuterium->getFormattedLong()); ?></span>
        </li>
        <li class="resource_list_el tooltipCustom" title="<?php echo e($resources->energy->getFormattedFull()); ?>">
            <div class="resourceIcon energy"></div>
            <span class="res_value"><?php echo e($resources->energy->getFormattedLong()); ?></span>
        </li>
    </ul>
    <!--
    <ul class="detail_list clearfix" data-type="resources">
    ...
    <div class="section_title">
        <div class="c-left"></div>
        <div class="c-right"></div>
        <span class="title_txt"><?php echo app('translator')->get('debris field'); ?></span>
    </div>
    <ul class="detail_list clearfix" data-type="resources">
        <li class="resource_list_el tooltipCustom" title="<?php echo e($debris->metal->getFormattedFull()); ?>">
            <div class="resourceIcon metal"></div>
            <span class="res_value"><?php echo e($debris->metal->getFormattedLong()); ?></span>
        </li>
        <li class="resource_list_el tooltipCustom" title="<?php echo e($debris->crystal->getFormattedFull()); ?>">
            <div class="resourceIcon crystal"></div>
            <span class="res_value"><?php echo e($debris->crystal->getFormattedLong()); ?></span>
        </li>
        <li class="resource_list_el tooltipCustom" title="<?php echo e($debris->deuterium->getFormattedFull()); ?>">
            <div class="resourceIcon deuterium"></div>
            <span class="res_value"><?php echo e($debris->deuterium->getFormattedLong()); ?></span>
        </li>
    </ul>
    <?php endif; ?>
    <div class="section_title">
        <div class="c-left"></div>
        <div class="c-right"></div>
        <span class="title_txt"><?php echo app('translator')->get('Fleets'); ?></span>
    </div>
    <ul class="detail_list clearfix" data-type="ships">
        <?php /** @var OGame\ViewModels\UnitViewModel $unit */ ?>
        <?php $__empty_1 = true; $__currentLoopData = $ships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li class="detail_list_el">
                <div class="shipImage float_left">
                    <img class="tech<?php echo e($unit->object->id); ?>" width="28" height="28" src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif">
                </div>
                <span class="detail_list_txt"><?php echo e($unit->object->title); ?></span>
                <span class="fright" style="margin-right: 10px;"><?php echo e($unit->amount); ?></span>
            </li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <?php echo app('translator')->get('We were unable to retrieve any reliable information of this type from the scan.'); ?>
        <?php endif; ?>
    </ul>
    ...
    <div class="section_title">
        <div class="c-left"></div>
        <div class="c-right"></div>
        <span class="title_txt"><?php echo app('translator')->get('Defense'); ?></span>
    </div>
    <ul class="detail_list clearfix" data-type="defense">
        <?php /** @var OGame\ViewModels\UnitViewModel $unit */ ?>
        <?php $__empty_1 = true; $__currentLoopData = $defense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li class="detail_list_el">
                <div class="defense_image float_left">
                    <img class="defense<?php echo e($unit->object->id); ?>" width="28" height="28" src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif">
                </div>
                <span class="detail_list_txt"><?php echo e($unit->object->title); ?></span>
                <span class="fright" style="margin-right: 10px;"><?php echo e($unit->amount); ?></span>
            </li>
    ...
    <div class="section_title">
        <div class="c-left"></div>
        <div class="c-right"></div>
        <span class="title_txt"><?php echo app('translator')->get('Building'); ?></span>
    </div>

    <ul class="detail_list clearfix" data-type="buildings">
        <?php /** @var OGame\ViewModels\UnitViewModel $unit */ ?>
        <?php $__empty_1 = true; $__currentLoopData = $buildings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li class="detail_list_el">
                <div class="building_image float_left">
                    <img class="building<?php echo e($unit->object->id); ?>" width="28" height="28" src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif">
                </div>
                <span class="detail_list_txt"><?php echo e($unit->object->title); ?></span>
                <span class="fright" style="margin-right: 10px;"><?php echo e($unit->amount); ?></span>
            </li>
    ...
    <div class="section_title">
        <div class="c-left"></div>
        <div class="c-right"></div>
        <span class="title_txt"><?php echo app('translator')->get('Research'); ?></span>
    </div>

    <ul class="detail_list clearfix" data-type="research">
        <?php $__empty_1 = true; $__currentLoopData = $research; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li class="detail_list_el">
                <div class="research_image float_left">
                    <img class="research<?php echo e($unit->object->id); ?>" width="28" height="28" src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif">
                </div>
                <span class="detail_list_txt"><?php echo e($unit->object->title); ?></span>
                <span class="fright" style="margin-right: 10px;"><?php echo e($unit->amount); ?></span>
            </li>
...
<?php /**PATH /var/www/resources/views/ingame/messages/templates/espionage_report_full.blade.php ENDPATH**/ ?>