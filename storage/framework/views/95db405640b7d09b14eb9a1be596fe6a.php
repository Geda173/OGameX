<?php $__env->startSection('content'); ?>
    ...
    <div id="researchcomponent" class="maincontent">
        <div id="research">
            <header id="planet" data-anchor="technologyDetails">
                <h2><?php echo app('translator')->get('Research'); ?> - <?php echo e($planet_name); ?></h2>
            </header>
            ...
            <div id="technologies">
                <div id="technologies_basic">
                    <h3><?php echo app('translator')->get('Basic research'); ?></h3>
                    <ul class="icons">
                        <?php /** @var OGame\ViewModels\ResearchViewModel $building */ ?>
                        <?php $__currentLoopData = $research[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('ingame.research.research-item', ['building' => $building, 'build_queue_max' => $build_queue_max], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <div id="technologies_drive">
                    <h3><?php echo app('translator')->get('Drive research'); ?></h3>
                    <ul class="icons">
                        <?php /** @var OGame\ViewModels\ResearchViewModel $building */ ?>
                        <?php $__currentLoopData = $research[1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('ingame.research.research-item', ['building' => $building, 'build_queue_max' => $build_queue_max], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <div id="technologies_advanced">
                    <h3><?php echo app('translator')->get('Advanced researches'); ?></h3>
                    <ul class="icons">
                        <?php /** @var OGame\ViewModels\ResearchViewModel $building */ ?>
                        <?php $__currentLoopData = $research[2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('ingame.research.research-item', ['building' => $building, 'build_queue_max' => $build_queue_max], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <div id="technologies_combat">
                    <h3><?php echo app('translator')->get('Combat research'); ?></h3>
                    <ul class="icons">
                        <?php /** @var OGame\ViewModels\ResearchViewModel $building */ ?>
                        <?php $__currentLoopData = $research[3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('ingame.research.research-item', ['building' => $building, 'build_queue_max' => $build_queue_max], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
        ...
        <div id="productionboxBottom">
            <div class="productionBoxResearch boxColumn research">
                <div id="productionboxresearchcomponent" class="productionboxresearch injectedComponent parent research"><div class="content-box-s">
                        <div class="header">
                            <h3><?php echo app('translator')->get('Research'); ?></h3>
                        </div>
                        <div class="content">
                            
                            <?php echo $__env->make('ingame.shared.buildqueue.research-active', ['build_active' => $build_active], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            
                            <?php echo $__env->make('ingame.shared.buildqueue.research-queue', ['build_queue' => $build_queue], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                        <div class="footer"></div>
                    </div>
                    <script type="text/javascript">
                        var scheduleBuildListEntryUrl = '<?php echo e(route('research.addbuildrequest.post')); ?>';
    ...
    <div id="technologydetailscomponent" class="technologydetails injectedComponent parent research">
        <script type="text/javascript">
            ...
            var technologyDetailsEndpoint = "<?php echo e(route('research.ajax')); ?>";
...
<?php echo $__env->make('ingame.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ingame/research/index.blade.php ENDPATH**/ ?>