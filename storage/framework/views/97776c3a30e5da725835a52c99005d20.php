<?php /** @var OGame\ViewModels\Queue\ResearchQueueListViewModel $build_queue */ ?>
            ...
            <?php $__currentLoopData = $build_queue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <td>
                    <a href="javascript:void(0);" class="queue_link tooltip js_hideTipOnMobile dark_highlight_tablet"
                       ...
                       title="">
                        <img class="queuePic"
                             src="<?php echo asset('img/objects/research/' . $item->object->assets->imgMicro); ?>" height="28"
...
<?php endif; ?><?php /**PATH /var/www/resources/views/ingame/shared/buildqueue/research-queue.blade.php ENDPATH**/ ?>