<?php /** @var OGame\ViewModels\Queue\ResearchQueueViewModel $build_active */ ?>
<?php if(!empty($build_active)): ?>
            ...
            <td class="first" rowspan="3">
                <div>
                    <a href="javascript:void(0);" class="tooltip js_hideTipOnMobile tpd-hideOnClickOutside" style="display: block;"
                       onclick="cancelbuilding(<?php echo e($build_active->object->id); ?>, <?php echo e($build_active->id); ?>,
   '<?php echo e(__('Research: do you really want to cancel :object_title level :level_target on planet :planet_name [:planet_coordinates]?', [
    ...
    ])); ?>'); return false;" title="<?php echo e(__('Research: do you really want to cancel :object_title level :level_target on planet :planet_name [:planet_coordinates]?', [
        'object_title' => $build_active->object->title,
        'level_target' => $build_active->level_target,
        'planet_name' => $build_active->planet->getPlanetName(),
        'planet_coordinates' => $build_active->planet->getPlanetCoordinates()->asString()
    ])); ?>">
                        <img class="queuePic" width="40" height="40" src="<?php echo asset('img/objects/research/' . $build_active->object->assets->imgSmall); ?>" alt="<?php echo e($build_active->object->title); ?>">
                    </a>
   ...
   '<?php echo e(__('Research: do you really want to cancel :object_title level :level_target on planet :planet_name [:planet_coordinates]?', [
        ...
        'planet_coordinates' => $build_active->planet->getPlanetCoordinates()->asString()
                       ...
                       title="<?php echo e(__('Research: do you really want to cancel :object_title level :level_target on planet :planet_name [:planet_coordinates]?', [
        'object_title' => $build_active->object->title,
        'level_target' => $build_active->level_target,
        'planet_name' => $build_active->planet->getPlanetName(),
        'planet_coordinates' => $build_active->planet->getPlanetCoordinates()->asString()
        ...
        <tr class="data">
            <td class="desc timer">
                <time class="countdown researchCountdown" data-segments="2"><?php echo e(\OGame\Facades\AppUtil::formatTimeDuration($build_active->time_countdown)); ?></time>
            </td>
        </tr>
        <tr class="data">
            <td colspan="2">
    ...
    <script type="text/javascript">
        var cancelBuildListEntryUrl = '<?php echo e(route('research.cancelbuildrequest')); ?>';
        ...
        new CountdownTimer('researchCountdown', <?php echo e($build_active->time_countdown); ?>,'<?php echo e(url()->current()); ?>',null,true,3)
            ...
            <tr>
                <td colspan="2" class="idle">
                    <a class="tooltip js_hideTipOnMobile
                                   " title="<?php echo app('translator')->get('There is no research done at the moment. Click here to get to your research lab.'); ?>" href="<?php echo e(url()->current()); ?>">
                        <?php echo app('translator')->get('There is no research in progress at the moment.'); ?></a>
                </td>
            </tr>
        </tbody>
    </table>
<?php endif; ?><?php /**PATH /var/www/resources/views/ingame/shared/buildqueue/research-active.blade.php ENDPATH**/ ?>