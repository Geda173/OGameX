        ...
        <div class="js_subtabs_fleets ui-tabs ui-corner-all ui-widget ui-widget-content">
            <ul class="subtabs ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header"
                ...
                <li id="subtabs-nfFleet20"
                    ...
                    aria-expanded="true">
                    <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'fleets', 'subtab' => 'espionage'])); ?>"
                       class="txt_link ui-tabs-anchor" role="presentation" tabindex="-1"
                       id="ui-id-13">
                        Espionage
                        <?php if($unread_messages_count['espionage'] > 0): ?>
                            <span>(<?php echo e($unread_messages_count['espionage']); ?>)</span>
                        <?php endif; ?>
                    </a>
                </li>
                <li id="subtabs-nfFleet21"
                    ...
                    aria-expanded="false">
                    <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'fleets', 'subtab' => 'combat_reports' ])); ?>"
                       class="txt_link ui-tabs-anchor" role="presentation" tabindex="-1"
                       id="ui-id-15">
                        Combat Reports
                        <?php if($unread_messages_count['combat_reports'] > 0): ?>
                            <span>(<?php echo e($unread_messages_count['combat_reports']); ?>)</span>
                        <?php endif; ?>
                    </a>
                </li>
                <li id="subtabs-nfFleet22"
                    ...
                    aria-expanded="false">
                    <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'fleets', 'subtab' => 'expeditions' ])); ?>"
                       class="txt_link ui-tabs-anchor" role="presentation" tabindex="-1"
                       id="ui-id-17">
                        Expeditions
                        <?php if($unread_messages_count['expeditions'] > 0): ?>
                            <span>(<?php echo e($unread_messages_count['expeditions']); ?>)</span>
                        <?php endif; ?>
                    </a>
                </li>
                <li id="subtabs-nfFleet23"
                    ...
                    aria-expanded="false">
                    <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'fleets', 'subtab' => 'transport' ])); ?>"
                       class="txt_link ui-tabs-anchor" role="presentation" tabindex="-1"
                       id="ui-id-19">
                        Unions/Transport
                        <?php if($unread_messages_count['transport'] > 0): ?>
                            <span>(<?php echo e($unread_messages_count['transport']); ?>)</span>
                        <?php endif; ?>
                    </a>
                </li>
                <li id="subtabs-nfFleet24"
                    ...
                    aria-expanded="false">
                    <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'fleets', 'subtab' => 'other' ])); ?>"
                       class="txt_link ui-tabs-anchor" role="presentation" tabindex="-1"
                       id="ui-id-21">
                        Other
                        <?php if($unread_messages_count['other'] > 0): ?>
                            <span>(<?php echo e($unread_messages_count['other']); ?>)</span>
                        <?php endif; ?>
                        <span></span>
                    </a>
                </li>
...
<?php /**PATH /var/www/resources/views/ingame/messages/tabs/fleets/tab.blade.php ENDPATH**/ ?>