<?php $__env->startSection('content'); ?>
    ...
    <div id="defensescomponent" class="maincontent">
        <div id="defense">
            <header id="planet" data-anchor="technologyDetails">
                <h2><?php echo app('translator')->get('Defense'); ?> - <?php echo e($planet_name); ?></h2>
            </header>
            ...
            <div id="technologies">
                <h3><?php echo app('translator')->get('Defensive structures'); ?></h3>
                <ul class="icons">
                    ...
                    <?php $__currentLoopData = $units[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('ingame.shipyard.unit-item', ['building' => $building], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div id="technologydetailscomponent" class="technologydetails injectedComponent parent defenses">
        <script type="text/javascript">
            ...
            var technologyDetailsEndpoint = "<?php echo e(route('defense.ajax')); ?>";
...
<?php echo $__env->make('ingame.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ingame/defense/index.blade.php ENDPATH**/ ?>