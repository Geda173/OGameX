...
-->
    ...
    <link rel="stylesheet" href="<?php echo e(mix('css/outgame.css')); ?>">
    <script type="text/javascript" src="<?php echo e(mix('js/outgame.min.js')); ?>"></script>
...
<div id="start">
    <div id="header">
        <h1>
            <a href="<?php echo e(route('login')); ?>" title="OGameX - Conquer the universe">
                OGame - Conquer the universe </a>
        </h1>
        <a id="loginBtn" href="javascript:void(0)" title="Login">
            Login </a>
        <div id="login">
            <form id="loginForm" name="loginForm" method="post" action="<?php echo e(route('login')); ?>">
    ...
    <div id="footerContent">
        <div class="linksAndCopyright">
            <div id="footerLinks">
                ...
                <p id="copyright">© OGameX. All rights reserved. <?php echo e(\OGame\Facades\GitInfoUtil::getAppVersion()); ?> </p>
            </div>
        </div>
    </div>
</div>
...
</html><?php /**PATH /var/www/resources/views/outgame/layouts/main.blade.php ENDPATH**/ ?>