<?php use OGame\Models\Enums\PlanetType; ?>
<?php /** @var OGame\Services\PlayerService $player */ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="fleetdispatchcomponent" class="maincontent">
        <script type="text/javascript">
            var checkTargetUrl = "<?php echo e(route('fleet.dispatch.checktarget')); ?>"
            var sendFleetUrl = "<?php echo e(route('fleet.dispatch.sendfleet')); ?>"
            var saveSettingsUrl = ""
            ...
            var DONUT_GALAXY = 1;
            var DONUT_SYSTEM = 1;
            var MAX_GALAXY = <?php echo e($settings->numberOfGalaxies()); ?>;
            var MAX_SYSTEM = 499;
            var MAX_POSITION = 16;
            var SPEEDFAKTOR_FLEET_PEACEFUL = <?php echo e($settings->fleetSpeed()); ?>;
            var SPEEDFAKTOR_FLEET_WAR = <?php echo e($settings->fleetSpeed()); ?>;
            var SPEEDFAKTOR_FLEET_HOLDING = <?php echo e($settings->fleetSpeed()); ?>;
            var PLANETTYPE_PLANET = 1;
            var PLANETTYPE_DEBRIS = 2;
            var PLANETTYPE_MOON = 3;
            var EXPEDITION_POSITION = 16;
            var MAX_NUMBER_OF_PLANETS = <?php echo e($player->getMaxPlanetAmount()); ?>;
            ...
            var currentPlanet = {
                "galaxy": <?php echo e($planet->getPlanetCoordinates()->galaxy); ?>,
                "system": <?php echo e($planet->getPlanetCoordinates()->system); ?>,
                "position": <?php echo e($planet->getPlanetCoordinates()->position); ?>,
                "type": <?php echo e($planet->getPlanetType()); ?>,
                "name": "<?php echo e($planet->getPlanetName()); ?>"
            };
            var targetPlanet = {
                "galaxy": <?php echo e($galaxy ?? $planet->getPlanetCoordinates()->galaxy); ?>,
                "system": <?php echo e($system ?? $planet->getPlanetCoordinates()->system); ?>,
                "position": <?php echo e($position ?? $planet->getPlanetCoordinates()->position); ?>,
                "type": <?php echo e($type ?? $planet->getPlanetType()); ?>,
                "name": "<?php echo e($targetPlanetName ?? $planet->getPlanetName()); ?>"
            };

            var targetPlayerId = "<?php echo e($targetPlayerId ?? $player->getId()); ?>";
            var targetPlayerName = "<?php echo e($targetPlayerName ?? $player->getUsername(false)); ?>";

            var shipsOnPlanet = [<?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unitGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php $__currentLoopData = $unitGroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if($unit->amount > 0): ?>{
                "id": <?php echo e($unit->object->id); ?>,
                "number": <?php echo e($unit->amount); ?>

            },<?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>];
            ...
            var mission = <?php echo e($mission ?? 0); ?>;
            var unionID = 0;
            var speed = 10;
            ...
            var metalOnPlanet = <?php echo e($planet->metal()->getRounded()); ?>;
            var crystalOnPlanet = <?php echo e($planet->crystal()->getRounded()); ?>;
            var deuteriumOnPlanet = <?php echo e($planet->deuterium()->getRounded()); ?>;
            var foodOnPlanet = 0;

            var fleetCount = <?php echo e($fleetSlotsInUse); ?>;
            var maxFleetCount = <?php echo e($fleetSlotsMax); ?>;
            var expeditionCount = 0;
            var maxExpeditionCount = 1;

            var warningsEnabled = true;

            var playerId = <?php echo e($player->getId()); ?>;
            var hasAdmiral = false;
            var hasCommander = false;
            var isOnVacation = false;

            var moveInProgress = false;
            var planetCount = <?php echo e($player->planets->planetCount()); ?>;
            ...
            var apiDataJson = {
                "coords": "<?php echo e($planet->getPlanetCoordinates()->asString()); ?>",
                "characterClassId": 2,
                "allianceClassId": 0,
            ...
            var apiCommonData = [["coords", "<?php echo e($planet->getPlanetCoordinates()->asString()); ?>"], ["characterClassId", 2]];
        ...
        <div id="fleet1">
            <div id="inhalt">
                ...
                <div id="planet" class="planet-header ">
                    <h2>Fleet Dispatch I - <?php echo e($planet->getPlanetName()); ?></h2>
                ...
                <div class="fleetStatus">
                    <div id="slots" class="fleft">
                        <div class="fleft">
                            <span class="tooltip advice <?php echo e($fleetSlotsInUse >= $fleetSlotsMax ? 'overmark' : ''); ?>" title="Used/Total fleet slots"><span>Fleets:</span> <?php echo e($fleetSlotsInUse); ?>/<?php echo e($fleetSlotsMax); ?></span>
                        ...
                        <div class="fleft">
                                        <span class="tooltip advice <?php echo e($expeditionSlotsInUse >= $expeditionSlotsMax ? 'overmark' : ''); ?>" title="Used/Total expedition slots">
                            <span>Expeditions:</span>
                            <?php echo e($expeditionSlotsInUse); ?>/<?php echo e($expeditionSlotsMax); ?>
                    ...
                    <div id="movements" class="fright">
                        <a class="tooltip js_hideTipOnMobile dark_highlight_tablet" title="To fleet movement"
                           href="<?php echo e(route('fleet.movement')); ?>">
...
The &amp;#96;tactical retreat&amp;#96; option ends with 500,000 points.">
                                ...
                                <input onclick="ajaxFormSubmit('tacticalRetreat', '<?php echo e(route('overview.index')); ?>#TODO_tacticalRetreat&amp;tacticalRetreatState=0');"
                                       type="radio" name="tacticalRetreat" value="0">
                                Never
                                <input onclick="ajaxFormSubmit('tacticalRetreat', '<?php echo e(route('overview.index')); ?>#TODO_tacticalRetreat&amp;tacticalRetreatState=5');"
                                       checked="&quot;checked&quot;" type="radio" name="tacticalRetreat" value="5"> 5:1
                                <input type="radio" disabled="disabled" name="tacticalRetreat">
                                <a href="<?php echo e(route('premium.index', ['openDetail' => '3'])); ?>"
                ...
                <?php if($shipAmount == 0): ?>
                    <div id="warning">
                        <h3><?php echo app('translator')->get('Fleet dispatch impossible'); ?></h3>
                        <p>
                            <span class="icon icon_warning"></span>
                            <?php echo app('translator')->get('There are no ships on this planet.'); ?>
                        </p>
                    </div>
                <?php else: ?>
                    <div class="fleetStatus" id="statusBarFleet">
                        <ul>
                            <li><span class="title"><?php echo app('translator')->get('Mission:'); ?></span> <span
                                        class="missionName"><?php echo app('translator')->get('Nothing has been selected'); ?></span></li>
                            <li><span class="title"><?php echo app('translator')->get('Target:'); ?></span> <span class="targetName">[<?php echo e($planet->getPlanetCoordinates()->asString()); ?>] <figure
                                            class="planetIcon <?php echo e($planet->isPlanet() ? 'planet' : 'moon'); ?> tooltip js_hideTipOnMobile"
                                            title="<?php echo e($planet->isPlanet() ? 'Planet' : 'Moon'); ?>"></figure><?php echo e($planet->getPlanetName()); ?></span></li>
                            <li><span class="title"><?php echo app('translator')->get('Player\'s Name:'); ?></span> <span
                                        class="targetPlayerName"><?php echo e($player->getUsername()); ?></span></li>
                        </ul>
                    </div>
                    <div id="buttonz">
                        <div class="content">
                            <form name="shipsChosen" id="shipsChosen" method="post"
                                  action="<?php echo e(route('overview.index')); ?>#TODO_page=fleet2">
                                <div id="technologies">
                                    <div id="battleships">
                                        <div class="header"><h2><?php echo app('translator')->get('Combat ships'); ?></h2></div>
                                        <ul id="military" class="iconsUNUSED">
                                            <?php /** @var OGame\ViewModels\UnitViewModel $object */ ?>
                                            <?php $__currentLoopData = $units[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="technology <?php echo e($object->object->class_name); ?> interactive hasDetails tooltip hideTooltipOnMouseenter js_hideTipOnMobile ipiHintable"
                                                    data-technology="<?php echo e($object->object->id); ?>"
                                                    data-status="<?php echo e($object->amount == 0 ? 'off' : 'on'); ?>"
                                                    data-is-spaceprovider="" aria-label="<?php echo e($object->object->title); ?>"
                                                    title="<?php echo e($object->object->title); ?> (<?php echo e($object->amount); ?>)"
                                                    data-ipi-hint="ipiFleetselect<?php echo e($object->object->class_name); ?>">
												<span class="icon sprite sprite_small small <?php echo e($object->object->class_name); ?>">
													<span class="amount" data-value="<?php echo e($object->amount); ?>"
                                                          data-bonus="0">
														<span><?php echo e(\OGame\Facades\AppUtil::formatNumberShort($object->amount)); ?></span> <span
                                                                class="bonus"></span>
													</span>
												</span>
                                                    <input type="text" name="<?php echo e($object->object->class_name); ?>"
                                                           data-ipi-highlight-step="ipiFleetselect<?php echo e($object->object->class_name); ?>" <?php echo e($object->amount == 0 ? 'disabled' : ''); ?>>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    </div>
                                    <div id="civilships">
                                        <div class="header"><h2><?php echo app('translator')->get('Civil ships'); ?></h2></div>
                                        <ul id="civil" class="iconsUNUSED">
                                            <?php /** @var OGame\ViewModels\QueueUnitViewModel $object */ ?>
                                            <?php $__currentLoopData = $units[1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="technology <?php echo e($object->object->class_name); ?> interactive hasDetails tooltip hideTooltipOnMouseenter js_hideTipOnMobile ipiHintable"
                                                    data-technology="<?php echo e($object->object->id); ?>"
                                                    data-status="<?php echo e($object->amount == 0 ? 'off' : 'on'); ?>"
                                                    data-is-spaceprovider="" aria-label="<?php echo e($object->object->title); ?>"
    ...
    <span class="icon sprite sprite_small small <?php echo e($object->object->class_name); ?>">
                    ...
                    <span class="amount" data-value="<?php echo e($object->amount); ?>" data-bonus="0">
                <span><?php echo e($object->amount); ?></span> <span class="bonus"></span>
            </span>
            </span>
                                ...
                                <span class="send_all">
                                    ...
                                    <div class="firstcol fleft">
                                        <a id="combatunits" class="overlay dark_highlight_tablet"
                                           data-overlay-inline="#zeuch666" data-overlay-title="Edit standard fleets">
                                            ...
                                            <?php echo app('translator')->get('Standard fleets'); ?>
                                        </a>
                                    ...
                                    <a id="continueToFleet2" class="continue off" href="">
                                        <span class="ipiHintable" data-ipi-hint="ipiFleetContinueToPage2"
                                              data-ipi-highlight-step="ipiFleetContinueToPage2"><?php echo app('translator')->get('Continue'); ?></span>
                                    </a>
                                    <div class="clearfloat"></div>
                                    <p class="info"><?php echo app('translator')->get('Nothing has been selected'); ?></p>
                                </div>
                            </div>
        ...
        <div id="fleet2" style="display: none;">
            ...
            <div id="inhalt">
                <div id="planet" class="planet-header ">
                    <h2><?php echo app('translator')->get('Fleet Dispatch II'); ?> - <?php echo e($planet->getPlanetName()); ?></h2>
                ...
                <div class="fleetStatus" id="statusBarFleet">
                    <ul>
                        <li><span class="title"><?php echo app('translator')->get('Mission:'); ?></span> <span
                                    class="missionName"><?php echo app('translator')->get('Nothing has been selected'); ?></span></li>
                        <li><span class="title"><?php echo app('translator')->get('Target:'); ?></span> <span class="targetName">[<?php echo e($planet->getPlanetCoordinates()->asString()); ?>] <figure
                                        class="planetIcon <?php echo e($planet->isPlanet() ? 'planet' : 'moon'); ?> tooltip js_hideTipOnMobile" title="<?php echo e($planet->isPlanet() ? 'Planet' : 'Moon'); ?>"></figure><?php echo e($planet->getPlanetName()); ?></span>
                        </li>
                        <li><span class="title"><?php echo app('translator')->get('Player\'s Name:'); ?></span> <span
                                    class="targetPlayerName"><?php echo e($player->getUsername()); ?></span></li>
                    </ul>
                ...
                <div id="buttonz" class="sortable ui-sortable">
                    ...
                    <div id="fleetboxdestination" class="ui-state-default">
                        ...
                        <div class="content">
                            ...
                            <table cellpadding="0" cellspacing="0" id="mission">
                                <tbody>
                                <tr>
                                    <th><h2><?php echo app('translator')->get('Origin:'); ?></h2></th>
                                    <th></th>
                                    <th><h2><?php echo app('translator')->get('Destination:'); ?></h2></th>
                                    <th></th>
                                </tr>
                                <tr>
                                    <td id="start" class="border5px">
                                        <div class="planetname"><?php echo e($planet->getPlanetName()); ?></div>
                                        <div class="target">
                                            <a class="planet_source<?php echo e($planet->isPlanet() ? '_selected' : ''); ?>">
                                                <span class="textlabel"><?php echo app('translator')->get('Planet'); ?></span>
                                            </a>
                                            <a class="moon_source<?php echo e($planet->isMoon() ? '_selected' : ''); ?>">
                                                <span class="textlabel"><?php echo app('translator')->get('Moon'); ?></span>
                                            </a>
                                            <br class="clearfloat">
                                        </div>
                                        <div class="coords">
                                            <?php echo app('translator')->get('Coordinates:'); ?>
                                            <span style="color: #ffffff; font-weight: bold;"><?php echo e($planet->getPlanetCoordinates()->asString()); ?></span>
                                        </div>
                                    </td>
                                    <td id="distance">
                                        <div id="distanceValue">5</div>
                                        <div class="coords"><?php echo app('translator')->get('Distance'); ?></div>
                                    </td>
                                    <td id="target" class="border5px">
                                        <div class="planetname" id="targetPlanetName"><?php echo e($planet->getPlanetName()); ?></div>
                                        <div class="target">
                                            <a class="planet<?php echo e($planet->isPlanet() ? '_selected' : ''); ?>" href="" id="pbutton">
                                                <span class="textlabel"><?php echo app('translator')->get('Planet'); ?></span>
                                            </a>
                                            <a class="moon<?php echo e($planet->isMoon() ? '_selected' : ''); ?>" href="" id="mbutton">
                                                <span class="textlabel"><?php echo app('translator')->get('Moon'); ?></span>
                                            </a>
                                            <a class="debris" href="" id="dbutton">
                                                <span class="textlabel"><?php echo app('translator')->get('debris field'); ?></span>
                                            </a>
                                            <br class="clearfloat">
                                        </div>
                                        <div class="coords">
                                    ...
                                    <td id="shortcuts">
                                        <div>
                                            <span id="shortlinks tips"><?php echo app('translator')->get('Shortcuts:'); ?></span>
                                            <div class="glow">
                                                <select size="1" class="planets" id="slbox">
                                                    <option value="-">-</option>
                                                    <?php $__currentLoopData = $player->planets->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planet_record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($planet_record->getPlanetId() !== $planet->getPlanetId()): ?>
                                                        <option
                                                            value="<?php echo e($planet_record->getPlanetCoordinates()->galaxy); ?>#<?php echo e($planet_record->getPlanetCoordinates()->system); ?>#<?php echo e($planet_record->getPlanetCoordinates()->position); ?>#<?php echo e($planet_record->getPlanetType()); ?>#<?php echo e($planet_record->getPlanetName()); ?>"
                                                            data-html-prepend="<figure class=&quot;planetIcon <?php echo e($planet_record->getPlanetType() === PlanetType::Planet ? 'planet' : 'moon'); ?> tooltip js_hideTipOnMobile&quot; title=&quot;<?php echo e($planet_record->getPlanetType() === PlanetType::Planet ? 'Planet' : 'Moon'); ?>&quot;></figure>"
                                                            >
                                                            <?php echo e($planet_record->getPlanetName()); ?> [<?php echo e($planet_record->getPlanetCoordinates()->asString()); ?>]
                                                        </option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                        ...
                                        <div style="padding-top: 12px;">
                                            <span id="combatunits tips"><?php echo app('translator')->get('Combat forces:'); ?></span>
                                            <div class="glow">
                    ...
                    <div id="fleetboxmission" class="ui-state-default">
                        ...
                        <div class="header">
                            <h2><?php echo app('translator')->get('Select mission for target:'); ?></h2>
                        </div>
                        <div class="content">
                            <div class="ajax_loading" style="display: none;">
                                <div class="ajax_loading_overlay">
                            ...
                            <div id="attackMissionsDisabledBashingLimit" style="display: none;"><span
                                        class="icon icon_warning"></span> <?php echo app('translator')->get('Attack missions have been deactivated as a result of too many attacks on the target.'); ?>
                            </div>
                            <ul id="missions">
                                <li id="button15" class="off ipiHintable" data-ipi-hint="ipiFleetMission15">
                                    <a id="missionButton15" href="" data-mission="15"
                                       data-ipi-highlight-step="ipiFleetMission15">
                                        <span class="textlabel"><?php echo app('translator')->get('Expedition'); ?></span>
                                    </a>
                                </li>
                                <li id="button7" class="off ipiHintable" data-ipi-hint="ipiFleetMission7">
                                    <a id="missionButton7" href="" data-mission="7"
                                       data-ipi-highlight-step="ipiFleetMission7">
                                        <span class="textlabel"><?php echo app('translator')->get('Colonisation'); ?></span>
                                    </a>
                                </li>
                                <li id="button8" class="off ipiHintable" data-ipi-hint="ipiFleetMission8">
                                    <a id="missionButton8" href="" data-mission="8"
                                       data-ipi-highlight-step="ipiFleetMission8">
                                        <span class="textlabel"><?php echo app('translator')->get('Recycle Debris Field'); ?></span>
                                    </a>
                                </li>
                                <li id="button3" class="off ipiHintable" data-ipi-hint="ipiFleetMission3">
                                    <a id="missionButton3" href="" data-mission="3"
                                       data-ipi-highlight-step="ipiFleetMission3">
                                        <span class="textlabel"><?php echo app('translator')->get('Transport'); ?></span>
                                    </a>
                                </li>
                                <li id="button4" class="off ipiHintable" data-ipi-hint="ipiFleetMission4">
                                    <a id="missionButton4" href="" data-mission="4"
                                       data-ipi-highlight-step="ipiFleetMission4">
                                        <span class="textlabel"><?php echo app('translator')->get('Deployment'); ?></span>
                                    </a>
                                </li>
                                <li id="button6" class="off ipiHintable" data-ipi-hint="ipiFleetMission6">
                                    <a id="missionButton6" href="" data-mission="6"
                                       data-ipi-highlight-step="ipiFleetMission6">
                                        <span class="textlabel"><?php echo app('translator')->get('Espionage'); ?></span>
                                    </a>
                                </li>
                                <li id="button5" class="off ipiHintable" data-ipi-hint="ipiFleetMission5">
                                    <a id="missionButton5" href="" data-mission="5"
                                       data-ipi-highlight-step="ipiFleetMission5">
                                        <span class="textlabel"><?php echo app('translator')->get('ACS Defend'); ?></span>
                                    </a>
                                </li>
                                <li id="button1" class="off ipiHintable" data-ipi-hint="ipiFleetMission1">
                                    <a id="missionButton1" href="" data-mission="1"
                                       data-ipi-highlight-step="ipiFleetMission1">
                                        <span class="textlabel"><?php echo app('translator')->get('Attack'); ?></span>
                                    </a>
                                </li>
                                <li id="button2" class="off ipiHintable" data-ipi-hint="ipiFleetMission2">
                                    <a id="missionButton2" href="" data-mission="2"
                                       data-ipi-highlight-step="ipiFleetMission2">
                                        <span class="textlabel"><?php echo app('translator')->get('ACS Attack'); ?></span>
                                    </a>
                                </li>
                                <li id="button9" class="off ipiHintable" data-ipi-hint="ipiFleetMission9">
                                    <a id="missionButton9" href="" data-mission="9"
                                       data-ipi-highlight-step="ipiFleetMission9">
                                        <span class="textlabel"><?php echo app('translator')->get('Moon Destruction'); ?></span>
                                    </a>
                                </li>
                            </ul>
                            <br class="clearfloat">
                            <div id="missionNameWrapper" class="off">
                                <?php echo app('translator')->get('Mission:'); ?>
                                <span id="missionName" class="missionName"><?php echo app('translator')->get('Nothing has been selected'); ?></span>
                    ...
                    <div id="fleetboxbriefingandresources" class="ui-state-default">
                        ...
                        <div class="content">
                            ...
                            <form name="sendForm" method="post"
                                  action="<?php echo e(route('overview.index')); ?>#TODO_page=ingame&amp;component=movement">
                                <div id="mission">
                                    <div class="briefing_overlay"><?php echo app('translator')->get('You cannot start this mission.'); ?></div>
                                    ...
                                    <div class="missionHeader"><?php echo app('translator')->get('Briefing:'); ?></div>
                                    <div class="missionHeader"><?php echo app('translator')->get('Load resources:'); ?></div>
                                    <!-- START: Briefing -->
                            ...
                            <square-checkbox id="fleetRetreatSquareCheckbox">
                                ...
                                <label for="square-checkboxRetreatAfterDefenderRetreat"></label>
                                            ...
                                            <li>
                                                <?php echo app('translator')->get('Target:'); ?>
                                                <span class="value tooltip active tpd-hideOnClickOutside"
                                                      id="targetPlanet" title="">[<?php echo e($planet->getPlanetCoordinates()->asString()); ?>] <?php echo e($planet->getPlanetName()); ?></span>
                                            </li>
                                            <li>
                                                <?php echo app('translator')->get('Duration of flight (one way):'); ?>
                                                <span class="value" id="duration">0:00:00 h</span>
                                            </li>
                                            <li>
                                                <?php echo app('translator')->get('Arrival:'); ?> <span class="value"><span
                                                            id="arrivalTime">18.03.24 23:16:15</span> <?php echo app('translator')->get('Clock'); ?></span>
                                            </li>
                                            <li>
                                                <?php echo app('translator')->get('Return:'); ?> <span class="value"><span
                                                            id="returnTime">18.03.24 23:16:15</span> <?php echo app('translator')->get('Clock'); ?></span>
                                            </li>
                                            <li>
                                                <?php echo app('translator')->get('Deuterium consumption:'); ?>
                                                <span class="value"><span id="consumption"><span class="undermark">0 (NaN%)</span></span></span>
                                            </li>
                                            <li>
                                                <?php echo app('translator')->get('Empty cargobays:'); ?> <span class="value" id="storage"><span
                                                            class="undermark">0</span></span>
                                            </li>
                                            <li id="holdtimeline" style="display: none;">
                                                <?php echo app('translator')->get('Hold time:'); ?>
                                            ...
                                            <li id="expeditiontimeline">
                                                <?php echo app('translator')->get('Duration of expedition:'); ?>
                                            ...
                                            <li>
                                                ...
                                                <?php echo app('translator')->get('Speed:'); ?> (<?php echo app('translator')->get('max.'); ?> <span id="maxspeed">1,000,000,000</span>)
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- END: Briefing -->
                                    ...
                                    <div class="border5px">
                                        <div id="resources" class="border5px lifeforms-enabled">
                                            <div class="res_wrap border3px">
                                                ...
                                                <div class="res">
                                                    <input type="text" pattern="[0-9,.]*"
                                                           ...
                                                           tabindex="1" id="metal"
                                                           value="<?php echo e($planet->metal()->get()); ?>">
                                            ...
                                            <div class="res_wrap border3px">
                                                ...
                                                <div class="res">
                                                    <input type="text" pattern="[0-9,.]*"
                                                           ...
                                                           id="crystal" value="<?php echo e($planet->crystal()->get()); ?>"
                                                           tabindex="2">
                                            ...
                                            <div class="res_wrap border3px">
                                                ...
                                                <div class="res">
                                                    <input type="text" pattern="[0-9,.]*"
                                                           ...
                                                           value="<?php echo e($planet->deuterium()->get()); ?>" tabindex="3">
                                            ...
                                            <div class="fleet_dispatch_toggle_wrap" style="display: none;">
                                                <span><?php echo app('translator')->get('Plunder food:'); ?></span>
                                                <toggle-switch>
                                            ...
                                            <div id="loadAllResources">
                                                ...
                                                <?php echo app('translator')->get('all resources'); ?>
                                            </div>
                                            <div id="loadRoom">
                                                <?php echo app('translator')->get('cargo bay:'); ?>
                                ...
                                <div id="naviActions">
                                    <a id="sendFleet" class="start ipiHintable off" href=""
                                       data-ipi-hint="ipiFleetSend">
                                        <span style="padding-top:9px;"><?php echo app('translator')->get('Send fleet'); ?></span>
                                    </a>
                                    <a id="backToFleet1" class="back" href="">
                                        <span style="font-size:12px; text-transform:uppercase;"><?php echo app('translator')->get('Back'); ?></span>
                                    </a>
                                    <br class="clearfloat">
                                </div>
                            </form>
...
<?php echo $__env->make('ingame.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ingame/fleet/index.blade.php ENDPATH**/ ?>