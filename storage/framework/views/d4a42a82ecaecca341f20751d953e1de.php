        ...
        <ul class="tab_inner clearfix">
            ...
            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="msg <?php if($message->isUnread()): ?> msg_new <?php endif; ?>" data-msg-id="<?php echo e($message->getId()); ?>">
                    ...
                    <div class="msg_head">
                        <span class="msg_title blue_txt"><?php echo e($message->getSubject()); ?></span>
                        <span class="fright">
...
</div><?php /**PATH /var/www/resources/views/ingame/messages/tabs/default/subtab.blade.php ENDPATH**/ ?>