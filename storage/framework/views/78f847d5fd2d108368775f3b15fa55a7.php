                ...
                <div class="js_tabs tabs_wrap ui-tabs ui-corner-all ui-widget ui-widget-content">
                    <ul class="tabs_btn ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header"
                        ...
                        <li id="tabs-nfFleets"
                            ...
                            <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'fleets'])); ?>"
                               class="tabs_btn_img tb_fleets ui-tabs-anchor"
                               rel="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'fleets'])); ?>" role="presentation" tabindex="-1"
                               id="ui-id-1">
                                <?php if($unread_messages_count['fleets'] > 0): ?>
                                    <span class="new_msg_count"><?php echo e($unread_messages_count['fleets']); ?></span>
                                <?php endif; ?>
                        ...
                        <li id="tabs-nfCommunication"
                            ...
                            <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'communication'])); ?>"
                               class="tabs_btn_img tb_communication ui-tabs-anchor"
                               rel="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'communication'])); ?>" role="presentation" tabindex="-1"
                               id="ui-id-3">
                                <?php if($unread_messages_count['communication'] > 0): ?>
                                    <span class="new_msg_count"><?php echo e($unread_messages_count['communication']); ?></span>
                                <?php endif; ?>
                                <img src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif" height="54" width="54">
                                <div class="marker"></div>
                        ...
                        <li id="tabs-nfEconomy" class="list_item ui-tabs-tab ui-corner-top ui-state-default ui-tab"
                            ...
                            aria-selected="false" aria-expanded="false">
                            <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'economy'])); ?>"
                               class="tabs_btn_img tb_economy ui-tabs-anchor"
                               rel="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'economy'])); ?>" role="presentation" tabindex="-1"
                               id="ui-id-5">
                                <?php if($unread_messages_count['economy'] > 0): ?>
                                    <span class="new_msg_count"><?php echo e($unread_messages_count['economy']); ?></span>
                                <?php endif; ?>
                                <img src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif" height="54" width="54">
                                <div class="marker"></div>
                        ...
                        <li id="tabs-nfUniverse" class="list_item ui-tabs-tab ui-corner-top ui-state-default ui-tab"
                            ...
                            aria-selected="false" aria-expanded="false">
                            <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'universe'])); ?>"
                               class="tabs_btn_img tb_universe ui-tabs-anchor"
                               rel="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'universe'])); ?>" role="presentation" tabindex="-1"
                               id="ui-id-7">
                                <?php if($unread_messages_count['universe'] > 0): ?>
                                    <span class="new_msg_count"><?php echo e($unread_messages_count['universe']); ?></span>
                                <?php endif; ?>
                                <img src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif" height="54" width="54">
                                <div class="marker"></div>
                        ...
                        <li id="tabs-nfSystem" class="list_item ui-tabs-tab ui-corner-top ui-state-default ui-tab"
                            ...
                            aria-selected="false" aria-expanded="false">
                            <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'system'])); ?>"
                               class="tabs_btn_img tb_system ui-tabs-anchor"
                               rel="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'system'])); ?>" role="presentation" tabindex="-1"
                               id="ui-id-9">
                                <?php if($unread_messages_count['system'] > 0): ?>
                                    <span class="new_msg_count"><?php echo e($unread_messages_count['system']); ?></span>
                                <?php endif; ?>
                                <img src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif" height="54" width="54">
                                <div class="marker"></div>
                        ...
                        <li id="tabs-nfFavorites" class="list_item ui-tabs-tab ui-corner-top ui-state-default ui-tab"
                            ...
                            aria-selected="false" aria-expanded="false">
                            <a href="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'favorites'])); ?>"
                               class="tabs_btn_img tb_favorites premiumHighligt ui-tabs-anchor"
                               rel="<?php echo e(route('messages.ajax.gettabcontents', ['tab' => 'favorites'])); ?>" role="presentation" tabindex="-1"
                               id="ui-id-11">
                                <?php if($unread_messages_count['favorites'] > 0): ?>
                                    <span class="new_msg_count"><?php echo e($unread_messages_count['favorites']); ?></span>
                                <?php endif; ?>
                                <img src="/img/icons/3e567d6f16d040326c7a0ea29a4f41.gif" height="54" width="54">
                                <div class="marker"></div>
...
<?php echo $__env->make('ingame.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/ingame/messages/index.blade.php ENDPATH**/ ?>