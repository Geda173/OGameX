<div id="eventListWrap">
    ...
    <table id="eventContent">
        ...
        <?php $__currentLoopData = $fleet_events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fleet_event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make('ingame.fleetevents.eventrow', ['fleet_event_row' => $fleet_event], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<script type="text/javascript">
    ...
    $("a.icon_link.recallFleet").click(function (e) {
        ...
        errorBoxDecision(
            ...
            "No",
            function() {
                $.post(ajaxRecallFleetURI, {fleet_mission_id: fleetId, _token: '<?php echo e(csrf_token()); ?>'}, (data) => {
...
<?php /**PATH /var/www/resources/views/ingame/fleetevents/eventlist.blade.php ENDPATH**/ ?>